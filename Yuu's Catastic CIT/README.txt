This is a pack that has cat and frog chairs using CIT. It requires the use of optifine, and I very highly recommend using Mizunos 16 texture pack (https://mizunomcmemo.blogspot.com/) with it. This pack will have updates (eventually), adding more models, lol. 
